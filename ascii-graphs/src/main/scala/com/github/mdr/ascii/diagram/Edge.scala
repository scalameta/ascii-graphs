...
trait Edge {
  ...
  /**
   * Is there an arrow associated with the given box (which must be part of this
   * edge)
   */
  ...
  /**
   * Is there an arrow associated with the other box than the given box (which
   * must be part of this edge)
   */
